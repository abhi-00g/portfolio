...
const PROJECTS = [
  ...
  },
  {
    ...
    description: "Full-stack personal finance app with JWT authentication, expense tracking, budget management with overspend detection and progress bars, and AI-powered insights via Cohere's command-r-plus model. Recurring expense detection uses date-interval matching with a 5-day tolerance window. 22 Jest + Supertest backend tests, GitHub Actions CI, and Docker Compose.",
    tech: ["Node.js", "Express", "React", "PostgreSQL", "Sequelize", "Cohere API", "Jest", "Docker"],
    color: "#f9a8d4",
